...
//											ctrl_1.PID[PID6].kp,ctrl_1.PID[PID6].ki,ctrl_1.PID[PID6].kd);
		ANO_DT_Send_PID(2,Balance_Kp,0,Balance_Kd,
											Velocity_Kp,Velocity_Kp,0,
											0,0,0);
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid3)
